...
setwd("/yunity/bt327/spatmort/brigg_trendler/MentalHealth/rscripts/modeling/models/7_22/MHA/male/Death_DepRate")
...
f_beta_cred_int_list <- readRDS("../../female/Death_DepRate/Diagnostics/beta_cred_int.rds")
...
ggplot(beta_cred_int, aes(x = AgeGroup, y = Mean)) +
  ...
  labs(
    title = "Effect of DepRate on total_deaths for males by Age Group (Posterior Mean ± 95% CI)",
    x = "Age Group",
    y = "Posterior Mean"
  ) +
  ylim(ymin, ymax) +
