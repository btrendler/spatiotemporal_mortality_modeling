...
setwd("/yunity/bt327/spatmort/brigg_trendler/MentalHealth/rscripts/modeling/models/7_22/MHA/male/Suic_SIRate")
...
f_beta_cred_int_list <- readRDS("../../female/Suic_SIRate/Diagnostics/beta_cred_int.rds")
...
ggplot(beta_cred_int, aes(x = AgeGroup, y = Mean)) +
  ...
  labs(
    title = "Effect of SIRate on Y_suicide for males by Age Group (Posterior Mean ± 95% CI)",
    x = "Age Group",
    y = "Posterior Mean"
  ) +
  ylim(ymin, ymax) +
