...
all_deltas <- readRDS("/yunity/bt327/spatmort/brigg_trendler/MentalHealth/rscripts/modeling/models/6_5/female/Death_BRFFS/Diagnostics/all_deltas.rds")
all_phis <- readRDS("/yunity/bt327/spatmort/brigg_trendler/MentalHealth/rscripts/modeling/models/6_5/female/Death_BRFFS/Diagnostics/all_phis.rds")
...
beta_summary_list <- readRDS("/yunity/bt327/spatmort/brigg_trendler/MentalHealth/rscripts/modeling/models/6_5/female/Death_BRFFS/Diagnostics/beta_summary_list.rds")
...
beta_cred_int_list <- readRDS("/yunity/bt327/spatmort/brigg_trendler/MentalHealth/rscripts/modeling/models/6_5/female/Death_BRFFS/Diagnostics/beta_cred_int.rds")
...
ggplot(beta_cred_int, aes(x = AgeGroup, y = Mean)) +
  ...
  labs(
    title = "Effect of MentalHealthDays on total_deaths for females by Age Group (Posterior Mean ± 95% CI)",
    x = "Age Group",
    y = "Posterior Mean"
  ) +
  theme_minimal()
